...
<body style="background-image:url(imgs/bg_index.png);background-size: 100%">
    ...
    <div class="main">
        ...
        <form name="form_login" action="admin_login" method="post" onsubmit="return check()">
            <input type="text" name="userName" placeholder="请输入账号" value="123" onfocus="this.value='';">
            <input type="password" name="passwd" placeholder="请输入密码" value="123" onfocus="this.value='';">
